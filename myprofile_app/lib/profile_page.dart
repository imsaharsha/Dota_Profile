...
class _MyInfoState extends State<MyInfo> {
            ...
            child: Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('images/shinbo.png'), fit: BoxFit.cover),
              ),
            ),
          ),
          FractionallySizedBox(
  ...
  Row _infoSection() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _infoCell(title: 'Matches', value: '2578'),
        Container(
          width: 1,
          height: 40,
          color: Colors.black12,
        ),
        _infoCell(title: 'Play Time', value: '2750.4'),
        Container(
          width: 1,
          height: 40,
          color: Colors.black12,
        ),
        _infoCell(title: 'Rank', value: 'Archon'),
        Container(
          width: 1,
          height: 40,
          color: Colors.black12,
